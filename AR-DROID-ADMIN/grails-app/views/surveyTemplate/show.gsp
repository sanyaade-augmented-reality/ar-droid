            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="surveyTemplate.id.label" default="Id" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="surveyTemplate.description.label" default="Description" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="surveyTemplate.questions.label" default="Questions" /></td>
